...
export default function QuizForm() {
    ...
    const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const payload = {
            ...
            timeLimit: String(fd.get("timeLimit") || ""),
            questionCount: Number(fd.get("questionCount") || 0),
        }

        console.log("[v0] Quiz create payload:", payload)
        toast("Quiz configured",)
    }

    return (
        <Card className="max-w-3xl mx-auto mt-8 border bg-card text-card-foreground">
            <CardContent className="p-6">
                <form onSubmit={onSubmit} className="flex flex-col gap-6">
                    ...
                    <div className="flex items-center justify-end gap-3">
                        <Button type="submit" className="text-xl px-">
                            Generate Quiz
                        </Button>
                    </div>
                </form>
